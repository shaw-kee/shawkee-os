import BulletListIcon from '@/assets/svg/Notes/Bullet_List.svg?react';
import GalleryIcon from '@/assets/svg/Notes/Gallery.svg?react';
import TrashCanIcon from '@/assets/svg/Notes/Trash_Can.svg?react';
import NewNoteIcon from '@/assets/svg/Notes/New_Note.svg?react';
import BackwardIcon from '@/assets/svg/Notes/Backward.svg?react';
