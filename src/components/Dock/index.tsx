...
const Dock = () => {
  ...
  return (
    <div
      ...
      className='absolute bottom-[5px] left-[50%] z-50 flex translate-x-[-50%] gap-1 rounded-2xl border border-[#f3f3f323] bg-[#F6F6F6]/[0.36] p-1 shadow-[0_0_6px_0_rgba(0,0,0,0.15)] backdrop-blur-[68px]'
