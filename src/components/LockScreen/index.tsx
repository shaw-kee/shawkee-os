...
const LockScreen = () => {
  ...
  return (
    <form onSubmit={handleSubmit} className='relative flex h-full w-full flex-col items-center justify-between'>
      <div className='mt-12 text-center leading-[1] text-white'>
      ...
      <div className='mb-12 flex flex-col items-center gap-4'>
        ...
        <input
          type='password'
          className='rounded-lg bg-slate-600/90 px-2 py-0.5 text-sm tracking-wide text-slate-400 outline-none'
